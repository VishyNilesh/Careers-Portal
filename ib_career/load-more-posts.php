...
get_header();
?>
<link rel="stylesheet" href="<?php bloginfo( 'template_directory' )?>/assets/css/opening_post.css?q=1005">
...
<div class="container">
<div class="container">
    <p class="more-text-header">Jobs not matching your skillset?<br><span class="more-text-para">We are open and all ears! Submit your details and résumé <span class="font-purple" data-toggle="modal" data-target="#myModal" onclick="jo_apply('other');"><u style="cursor:pointer;">here</u></span></span>
</p>
...
<div class="second-fold container">
    <div class="container">
        <div class="">
            <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12" style="padding-left:0px;">
